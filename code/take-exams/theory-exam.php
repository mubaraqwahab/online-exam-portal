...
$questionSql = "SELECT * FROM `theory_question` WHERE exam_id = ? ORDER BY question_no ASC";
              ...
              while ($question = $questionResult->fetch_assoc()) {
                ...
                <div class="card my-3">
                  <div class="card-body">
                    ...
                    <textarea class="form-control" name="response'. $question['question_no'] .'" maxlength="256"></textarea>
                  </div>
                </div>
                ';
              }
