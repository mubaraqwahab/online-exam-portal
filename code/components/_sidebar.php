<div class="bg-light border-right" id="sidebar-wrapper">
  <div class="sticky-top pt-2">
    ...
    <div class="list-group list-group-flush">
      <a href="<?php echo ROOT_DIR . 'notifications/' ?>" class="list-group-item list-group-item-action bg-light" id="notifications">Notifications</a>
      <span class="list-group-item bg-light"><b>For Instructors</b></span>
