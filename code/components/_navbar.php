<nav class="navbar navbar-light sticky-top bg-light border-bottom">
  ...
  <div class="dropdown">
    <button class="btn" id="profileDropdown" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
      ...
      <img src="../profile-pic/<?php echo (!file_exists(PROFILE_TARGET_DIR . $profilePicture) ? 'blank-square.jpg' : $profilePicture); ?>" class="rounded-circle" height="30px" width="30px">
    </button>
